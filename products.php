...
<html>
    <head>
        <link rel="shortcut icon" href="img/comicBook.png" />
        <title>Booker</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Booker!</h1>
                    <p>We have the best collection of  all kind of books.No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/great_selection_and_great_seller.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Great selection and Great Seller</h3>
                                    <p>Price: Rs. 700.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/great_jason_shook.jpg" alt="Comic Book">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Great by Jason Shook</h3>
                                    <p>Price: Rs. 400.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/civil_wars.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Civil wars</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/super_awesome.jpg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Super Awesome</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/little_fires_everyWhere.jpg" alt="">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sold_on_a_monday.jpg" alt=" ">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sold On a Monday</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Bad_blood.JPG" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bad Blood</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/educated.jpg" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Educated</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/My_invention.jpg" alt="Raymond shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>My Invention</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Mamba_kobe.jpg" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mamba the mentality</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/becoming.jpg" alt="HXR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Becoming by Mitchel Obama</h3>
                                    <p>Price: Rs. 900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Open_book.jpg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Open Book</h3>
           ...
           <footer class="footer">
               ...
               <center>
                   ...
                   <p>This website is developed by Diksha</p>
               </center>
               </div>
           </footer>
        </div>
